...
- All participants are requested to complete the **Concurrent Session Sign-up Form** (see Welcome emails for the link). This is the *only* way you'll get Zoom link for the concurrent sessions.

- Links for Zoom sessions are unique for each person and being sent by email. If you have not gotten a Zoom link for the opening day by <u>2pm Friday June 19</u>, please check your **spam folder** first, then contact [ANR Program Support](mailto:ANRProgramSupport@ucanr.edu).

- For opening session on Monday June 22, use the connection link you got in an email with subject line *"DroneCamp Mon, Jun 22 9:00-15:50 Confirmation"*
