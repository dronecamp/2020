...
We recommend using **Standalone installer**. Please install the **long-term release (most stable)** version, which is currently QGIS 3.10.5 (A Coruña). 

Installation is usually very straight-forward. For more detailed instructions, please visit https://qgis.org/en/site/forusers/alldownloads.html
