...
if (download_data) {
 ...
 dc20_wkshps_tbl <- googlesheets4::read_sheet(ss = dc20_wkshps_id, sheet = "Workshops - Responses", range = NULL)
 subst_tbl <- googlesheets4::read_sheet(ss = dc20_wkshps_id, sheet = "Substitutions", range = NULL)
